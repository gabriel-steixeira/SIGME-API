...
public class Main {
    public static void main(String[] args) throws SQLException {
        Date dataValidade = new Date(2024, 5, 16);
        Date dataLote = new Date(2024, 5, 16);
        Date dataCadastro = new Date(2024, 5, 16);
        Date dataAlteracao = new Date(2024, 5, 16);
        ...
        Fornecedor fornecedor1 = new Fornecedor(1, "Jhonsom", "Jhonsom & Jhonsom", "123456789/0001-24", "jhonsom@gmail.com", "11987654321", "gabriel.teixeira", "gabriel.teixeira");
